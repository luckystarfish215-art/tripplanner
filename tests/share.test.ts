...
import { buildShareUrl, decodeTrip, deserializeTrip, encodeTrip, generateShareId, serializeTrip } from "../src/lib/share";
...
test("builds an absolute share URL", () => {
  assert.equal(buildShareUrl("https://tripplanner-xxxxx.vercel.app", "abc123"), "https://tripplanner-xxxxx.vercel.app/trip/abc123");
});
